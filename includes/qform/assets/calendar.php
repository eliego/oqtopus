...
<head>
	...
	<script type="text/javascript">
		function selectDate(intTimestamp) {
			document.location = "calendar.php?intTimestamp=" + intTimestamp + "<?php echo $strQueryArgs; ?>";
		}
...
?>
		<tr>
			<td colspan="7">Selected Day: <?php echo date("n/j/Y", $intTimestamp); ?><br />&nbsp;</td>
		</tr>
	</table>
